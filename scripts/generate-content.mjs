// 실버 SOS - 매일 AI 콘텐츠 자동 생성 스크립트 (Google Gemini 무료 티어 사용)
// GitHub Actions가 매일 실행. GEMINI_API_KEY 환경변수 필요. (aistudio.google.com에서 무료 발급)
...
if (!API_KEY) { console.error('GEMINI_API_KEY가 없습니다. GitHub Secrets에 등록하세요.'); process.exit(1); }
